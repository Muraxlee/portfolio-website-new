        ...
        <div class="project-category" data-aos="fade-up">
          ...
          <div class="grid grid-2">
            <div class="project-card" data-aos="fade-up" data-aos-delay="100">
              <div class="project-image">
                ...
                <img src="assets/images/InvoiceFlow.webp" alt="Invoice Management SaaS">
            ...
            <div class="project-card" data-aos="fade-up" data-aos-delay="200">
              <div class="project-image">
                <div class="project-badge">Web App</div>
                <img src="assets/images/mentore Agro.webp" alt="Mentore Agro Products">
                <div class="project-overlay">
          ...
          <div class="grid grid-2 mt-4">
            <div class="project-card" data-aos="fade-up" data-aos-delay="300">
              <div class="project-image">
                <div class="project-badge">Web App</div>
                <img src="assets/images/SnakHive.webp" alt="SnackHives">
                <div class="project-overlay">
            ...
            <div class="project-card" data-aos="fade-up" data-aos-delay="400">
              <div class="project-image">
                <div class="project-badge">Web App</div>
                <img src="assets/images/AgenTracker.webp" alt="Agent GPS Tracker">
                <div class="project-overlay">
          ...
          <div class="grid grid-2 mt-4">
            <div class="project-card" data-aos="fade-up" data-aos-delay="500">
              <div class="project-image">
                <div class="project-badge">Web App</div>
                <img src="assets/images/Tindog.webp" alt="TinDog">
                <div class="project-overlay">
          ...
          <div class="grid grid-2">
            <div class="project-card" data-aos="fade-up" data-aos-delay="100">
              <div class="project-image">
                ...
                <img src="assets/images/thamnail_kants.webp" alt="Kant – Anonymous Social App">
                <div class="project-overlay">
          ...
          <div class="grid grid-2">
            <div class="project-card" data-aos="fade-up" data-aos-delay="100">
              <div class="project-image">
                ...
                <img src="assets/images/Banker.webp" alt="Banker – Pawnshop Management App">
                <div class="project-overlay">
